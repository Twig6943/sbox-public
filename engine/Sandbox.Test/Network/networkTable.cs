...
public class networkTable
{
	...
	public void SetValue()
	{
		...
		table.Register( 3, new NetworkTable.Entry { GetValue = () => false } );
	...
	{
		bool value = false;
		var serverTable = new NetworkTable();
		serverTable.Register( 3, new NetworkTable.Entry { GetValue = () => value, SetValue = v => value = (bool)v } );
...

		{
			...
			using var clientTable = new NetworkTable();
			clientTable.Register( 3, new NetworkTable.Entry { GetValue = () => clientValue, SetValue = v => clientValue = (bool)v } );
	...
	public void GetValue()
	{
		...
		var serverTable = new NetworkTable();
		serverTable.Register( 3, new NetworkTable.Entry { GetValue = () => value, SetValue = ( v ) => value = (float)v } );
	...
	public void ExchangeTest<T>( T a, T b, Action<T> modifyvalue = null )
	{
		...
		var serverTable = new NetworkTable();
		serverTable.Register( 3, new NetworkTable.Entry { TargetType = typeof( T ), GetValue = () => serverValue, SetValue = ( v ) => serverValue = v } );

		var client = new NetworkTable();
		object clientValue = default;
		client.Register( 3, new NetworkTable.Entry { TargetType = typeof( T ), GetValue = () => clientValue, SetValue = ( v ) => clientValue = v } );
